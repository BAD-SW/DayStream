...
function QueryHistoryPanel() {
  ...
  return (
    <div style={styles.panel}>
      ...
      {/* Detail Modal */}
      {selectedLog && (
        <div style={styles.overlay} onClick={() => setSelectedLog(null)}>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  modal: { background: 'var(--color-surface-elevated, var(--color-surface))', borderRadius: '12px', padding: '24px', width: '100%', maxWidth: '560px', maxHeight: '80vh', overflowY: 'auto' as const, boxShadow: '0 20px 60px rgba(0,0,0,0.3)' },
